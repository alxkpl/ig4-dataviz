...
Une variable quantitative discrète est une variable numérique dont l'ensemble des valeurs possibles $E$ est fini ou dénombrable.

**Exemple :**

- Nombre de pile sur 10 lancer : $E = \{0, \dots, 10\}$.

- Nombre d'essai avant la réussite d'un lancer : $E = \{1, 2, \dots\} = \mathbb N^*$.

- Age d'un individu (en année): $E = \mathbb N$
...
Toute variable issue d'une variable aléatoire continue. 

**Exemple :**

- Taille d'un individu : $E = \mathbb R_+$.

- Taux d'emprunt en banque : $E = [0,1]$.

- Age d'un individu : $E = \mathbb R_+$.
...
## Discrétisation de variables continues {.build}
